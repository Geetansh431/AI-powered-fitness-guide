                    ...
                    <div className="relative space-y-4">
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            <span className="px-4 py-1.5 rounded-full text-sm bg-orange-500/20 border border-orange-400/30 text-orange-300 flex items-center gap-2">
                                <Zap className="w-4 h-4" /> Strength
                            </span>
                        </div>
                        ...
                        <p className="text-zinc-300 text-xl max-w-2xl leading-relaxed">
                            Transform your fitness with this powerful strength-training workout designed to build muscle and enhance endurance.
                        </p>
                    </div>
                </div>
                    ...
                    {activeTab === 'overview' && (
                        <>
                            ...
                            <div className="grid md:grid-cols-3 gap-6">
                                {[
                                    { icon: Timer, color: 'text-blue-400', bgColor: 'bg-blue-400/10', title: 'Duration', value: '45 Min', desc: 'Optimal workout length' },
                                    { icon: Flame, color: 'text-orange-400', bgColor: 'bg-orange-400/10', title: 'Calories', value: '350 cal', desc: 'Average burn rate' },
                                    { icon: Heart, color: 'text-red-400', bgColor: 'bg-red-400/10', title: 'Intensity', value: 'High', desc: 'Advanced level workout' }
                                ].map((stat, index) => (
                                    ...
                                    <div className="relative p-6">
                                        ...
                                        <div className="flex items-center gap-6 mb-6">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-zinc-400">Strength Specialist • 4+ years experience</p>
                                            </div>
                                        </div>
