                ...
                <div className="relative">
                    ...
                    <div className="relative space-y-4">
                        ...
                        <p className="text-zinc-300 text-xl max-w-2xl leading-relaxed">
                            Transform your fitness with this high-intensity workout designed to maximize calorie burn and improve endurance.
                        </p>
                    </div>
                </div>
                        ...
                        <>
                            ...
                            <div className="grid md:grid-cols-3 gap-6">
                                {[
                                    ...
                                    { icon: Flame, color: 'text-orange-400', bgColor: 'bg-orange-400/10', title: 'Calories', value: '400 cal', desc: 'Average burn rate' },
                                    ...
                                    <div className="relative p-6">
                                        ...
                                        <div className="flex items-center gap-6 mb-6">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-zinc-400">HIIT Specialist • 8+ years experience</p>
                                            </div>
                                        </div>
