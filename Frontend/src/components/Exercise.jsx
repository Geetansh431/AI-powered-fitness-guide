        ...
        const fetchExerciseData = async () => {
            try {
                ...
                setWorkoutStats(prev => ({
                    bestStreak: Math.max(prev.bestStreak, Math.max(...Object.values(data))),
                    totalReps: Object.values(data).reduce((a, b) => a + b, 0),
                    avgSpeed: Math.round((Object.values(data).reduce((a, b) => a + b, 0) / (duration * 60 - timeLeft)) * 100) / 100
                }));
            } catch (error) {
